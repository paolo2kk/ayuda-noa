...
PhysBody* ModulePhysics::CreateCircle(int x, int y, int radius, int mass)
{
	...
	b2MassData massFromUser;
	massFromUser.center = b2Vec2_zero;
	massFromUser.I = 0;
	massFromUser.mass = mass;

	b->CreateFixture(&fixture);
	b->SetMassData(&massFromUser);
